...
const Header = () => {
  return (
    <>
      <div className="w-full z-50 bg-white/40 sm:w-[60%] text-center rounded-br-full rounded-bl-full mx-auto p-4 fixed top-0 left-0 right-0 backdrop-blur-xl shadow-xl shadow-black/10">
